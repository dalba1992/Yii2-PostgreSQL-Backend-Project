			...
			<div class="widget-title">
				...
				<form id="page-changer" name="form1" method="GET" action="">
					<div class="filter"><label>Show
						 <select  class="pagination form-control" onchange="<?php if(isset($_GET['page'])){?>window.location.href='?per-page='+this.options[this.selectedIndex].text+'&page=<?php echo $_GET['page']; ?>'<?php }else { ?>window.location.href='?per-page='+this.options[this.selectedIndex].text<?php } ?>">
