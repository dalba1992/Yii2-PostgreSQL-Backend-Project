...
//$new_obj = new Recurly_Account();
    if ($node_class == null)
      ...
      if ($node_class == 'Recurly_CurrencyList') {
        $new_obj = new Recurly_CurrencyList($nodeName);
      } else {
	  	//echo $node_class; die;
		//echo \Yii::$app->basePath. '/lib' . '/recurly/'.$node_class.'.php'; die;
        /*require_once(\Yii::$app->basePath. '/lib' . '/recurly/'.$node_class.'.php');
		$new_obj = new $node_class();*/
		if($node_class=='Recurly_Account') {
			$new_obj = new Recurly_Account();
		} elseif($node_class=='Recurly_Currency') {
			$new_obj = new Recurly_Currency();
		} elseif($node_class=='Recurly_ErrorList') {
			$new_obj = new Recurly_ErrorList();
		} elseif($node_class=='Recurly_Link') {
			$new_obj = new Recurly_Link();
		} elseif($node_class=='Recurly_Pager') {
			$new_obj = new Recurly_Pager();
		} elseif($node_class=='Recurly_Stub') {
			$new_obj = new Recurly_Stub();
		} elseif($node_class=='Recurly_Address') {
			$new_obj = new Recurly_Address();
		} elseif($node_class=='Recurly_AccountList') {
			$new_obj = new Recurly_AccountList();
		} elseif($node_class=='Recurly_Addon') {
			$new_obj = new Recurly_Addon();
		} elseif($node_class=='Recurly_AddonList') {
			$new_obj = new Recurly_AddonList();
		} elseif($node_class=='Recurly_Adjustment') {
			$new_obj = new Recurly_Adjustment();
		} elseif($node_class=='Recurly_AdjustmentList') {
			$new_obj = new Recurly_AdjustmentList();
		} elseif($node_class=='Recurly_BillingInfo') {
			$new_obj = new Recurly_BillingInfo();
		} elseif($node_class=='Recurly_Coupon') {
			$new_obj = new Recurly_Coupon();
		} elseif($node_class=='Recurly_CouponList') {
			$new_obj = new Recurly_CouponList();
		} elseif($node_class=='Recurly_Invoice') {
			$new_obj = new Recurly_Invoice();
		} elseif($node_class=='Recurly_InvoiceList') {
			$new_obj = new Recurly_InvoiceList();
		} elseif($node_class=='Recurly_Note') {
			$new_obj = new Recurly_Note();
		} elseif($node_class=='Recurly_NoteList') {
			$new_obj = new Recurly_NoteList();
		} elseif($node_class=='Recurly_Plan') {
			$new_obj = new Recurly_Plan();
		} elseif($node_class=='Recurly_PlanList') {
			$new_obj = new Recurly_PlanList();
		} elseif($node_class=='Recurly_Redemption') {
			$new_obj = new Recurly_Redemption();
		} elseif($node_class=='Recurly_Subscription') {
			$new_obj = new Recurly_Subscription();
		} elseif($node_class=='Recurly_SubscriptionList') {
			$new_obj = new Recurly_SubscriptionList();
		} elseif($node_class=='Recurly_SubscriptionAddon') {
			$new_obj = new Recurly_SubscriptionAddon();
		} elseif($node_class=='Recurly_TaxDetail') {
			$new_obj = new Recurly_TaxDetail();
		} elseif($node_class=='Recurly_Transaction') {
			$new_obj = new Recurly_Transaction();
		} elseif($node_class=='Recurly_TransactionError') {
			$new_obj = new Recurly_TransactionError();
		} elseif($node_class=='Recurly_TransactionList') {
			$new_obj = new Recurly_TransactionList();
		} elseif($node_class=='Recurly_PushNotification') {
			$new_obj = new Recurly_PushNotification();
		} elseif($node_class=='Recurly_js') {
			$new_obj = new Recurly_js();
		}
