...
$this->title = 'Stripe Balance Transactions';
?>
    ...
    <div class="col-xs-12">
        <div class="widget-box">
            ...
            <div class="widget-title">
                ...
                <h5>Stripe Balance Transactions</h5>
                ...
                echo GridView::widget([
                    ...
                    'columns' => [
                        ...
                        ['attribute' => 'created',
                            'label'=>'Created Date',
                            'value' => function($data){
                                return date("m/d/Y H:i:s", $data->created);
                            },
                            'format' => 'html',
                        ...
                        ['attribute' => 'net',
                            ...
                            'filter' => false,
                            'value' => function($data){
                                return number_format(floatval($data->net) / 100, 2);
                            }
                        ],
                        ...
                        ['attribute' => 'available_on',
                            ...
                            'value' => function($data){
                                return date("m/d/Y H:i:s", $data->available_on);
                            },
                            'format' => 'html',
                            'filter' => \yii\jui\DatePicker::widget([
                                'language' => 'en',
                        ...
                        ['attribute' => 'fee',
                            ...
                            'filter' => false,
                            'value' => function($data){
                                return number_format(floatval($data->fee) / 100, 2);
                            }
                        ],
