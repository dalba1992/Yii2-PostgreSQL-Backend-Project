                ...
                echo GridView::widget([
                    ...
                    'columns' => [
                        ...
                        ['attribute' => 'amount_off',
                            'label'=>'Amount Off',
                            'value' => function($data){
                                return number_format(floatval($data->amount_off) / 100, 2);
                            },
                            'filter' => false,
                        ],
                        ...
                        ['attribute' => 'duration',
                            'label'=>'Duration',
                            'filter' => array('once'=>'once', 'forever'=>'forever', 'repeating'=>'repeating'),
                        ],
                        ...
                        ['attribute' => 'redeem_by',
                            ...
                            'value' => function($data){
                                if ($data->redeem_by != null)
                                    return gmdate("m/d/Y H:i:s", $data->redeem_by);
                            },
                            'filter' => false,
                        ],
                        ...
                        ['attribute' => 'valid',
                            'label'=>'Valid',
                            'filter' => array('true'=>'true', 'false'=>'false'),
                        ],
                    ],
                ]);
                ?>
