...
$this->title = 'Edit a Liteview Order';
...
$checked_ids = unserialize($modelLiteviewOrder->tradegecko_order_ids);
...
$cancelAction = Yii::$app->urlManager->createUrl('services/liteview/ordercancel');
...
<div id="content-header">
    <?php if ($modelLiteviewOrder->ifs_order_number != "") { ?>
    <h1><?php echo $this->title.'('.$modelLiteviewOrder->ifs_order_number.')'; ?></h1>
    <?php } else { ?>
                ...
                echo GridView::widget([
                    ...
                    'columns' => [
                        [
                            ...
                            'checkboxOptions' => function($model, $key, $index, $column) use ($checked_ids) {
                                if (in_array($model->id, $checked_ids))
...
<!--<div class="row">
    <div class="col-xs-12">
        <button type="submit" class="btn btn-large btn-success" id="createOrder" <?php if ($modelLiteviewOrder->liteview_order_status == 'Submitted') echo 'disabled'; ?>>Add to Liteview Order</button>
    </div>
</div>-->

<div class="row">
    <div class="col-xs-12" id="detailArea">
        <?php if ($modelLiteviewOrder->liteview_order_status == 'Submitted' || $modelLiteviewOrder->liteview_order_status == 'Re-Submitted') { ?>
        <?php echo Yii::$app->controller->renderPartial('detail', array('liteviewOrder'=>$liteviewOrder, 'flag' => '1', 'status'=>$modelLiteviewOrder->liteview_order_status)); ?>
        <?php } else if ($modelLiteviewOrder->liteview_order_status == 'Cancelled') { ?>
        <?php echo Yii::$app->controller->renderPartial('detail', array('liteviewOrder'=>$liteviewOrder, 'flag' => '2', 'status'=>$modelLiteviewOrder->liteview_order_status)); ?>
        <?php } else { ?>
        <?php echo Yii::$app->controller->renderPartial('detail', array('liteviewOrder'=>$liteviewOrder, 'flag' => '0', 'status'=>$modelLiteviewOrder->liteview_order_status)); ?>
        <?php } ?>
    </div>
</div>
...
<div id="message3" style="display: none;">
    <h4><i class="fa fa-spinner fa-pulse"></i> Cancelling Liteview Order now ...</h4>
</div><!-- /.modal -->
...
$search_script = str_replace('url: cancelAction', 'url: "'.$cancelAction.'"', $search_script);
