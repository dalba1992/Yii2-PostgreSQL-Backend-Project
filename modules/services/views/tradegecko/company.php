 ...
 * @var app\modules\services\models\TradegeckoCompanySearch $searchModel
 */
                        ...
                        [
                            ...
                            'buttons' => [
                                'view' => function($url, $model, $key) {
                                    return Html::a('View', ['companyview', 'id' => $model->id], ['class' => 'btn btn-default btn-xs']);
                                },
                                'delete' => function($url, $model, $key) {
                                    return Html::a('Delete', ['companydelete', 'id' => $model->id], ['data-confirm' => 'Are you sure?', 'class' => 'btn btn-danger btn-xs']);
                                },
                            ],
                            'template' => '
                                {view} {delete}
