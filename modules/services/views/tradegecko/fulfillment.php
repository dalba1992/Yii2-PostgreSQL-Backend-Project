 ...
 * @var app\modules\services\models\TradegeckoFulfillmentSearch $searchModel
 */
...
$this->title = 'Tradegecko Shipment';
?>
                ...
                echo GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'format' => 'raw',
                            'value' => function($data) {
                                $html = '<span class="label label-status status-'.$data->fulfillment_status.'">'.$data->fulfillment_status.'</span>';
                                return $html;
                            }
                        ],
                        ...
                        [
                            ...
                            'value' => function($data) {
                                return $data['tradegeckoLocation']['label'];
                            },
                        ],
                        ...
                        [
                            ...
                            'buttons' => [
                                'view' => function($url, $model, $key) {
                                    return Html::a('View', ['fulfillmentview', 'id' => $model->id], ['class' => 'btn btn-default btn-xs']);
                                },
                                'delete' => function($url, $model, $key) {
                                    return Html::a('Delete', ['fulfillmentdelete', 'id' => $model->id], ['data-confirm' => 'Are you sure?', 'class' => 'btn btn-danger btn-xs']);
                                },
                            ],
                            'template' => '
                                {view} {delete}
...
<div id="message" style="display: none;">
    <h4><i class="fa fa-spinner fa-pulse"></i> Syncing Shipment Data...</h4>
</div><!-- /.modal -->
...
$search_script = <<<JS
    $(function(){
        $('#syncTradeGecko').click(function(){
            ...
            $.ajax({
                url: '/services/tradegecko/syncfulfillment',
                type: 'POST',
