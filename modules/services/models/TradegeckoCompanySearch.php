...
/**
 * TradegeckoCompanySearch represents the model behind the search form about `modules\services\models\TradegeckoCompany`.
 */
class TradegeckoCompanySearch extends TradegeckoCompany
{
