...
/**
 * TradegeckoPaymentSearch represents the model behind the search form about `modules\services\models\TradegeckoPayment`.
 */
class TradegeckoPaymentSearch extends TradegeckoPayment
{
