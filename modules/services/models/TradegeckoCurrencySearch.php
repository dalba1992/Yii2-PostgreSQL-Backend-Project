...
/**
 * TradegeckoCurrencySearch represents the model behind the search form about `modules\services\models\TradegeckoCurrency`.
 */
class TradegeckoCurrencySearch extends TradegeckoCurrency
{
